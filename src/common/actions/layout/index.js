...
export const UI_OPEN_DIMMER = 'UI_OPEN_DIMMER'
export const UI_CLOSE_DIMMER = 'UI_CLOSE_DIMMER'
...
export const OPEN_DIMMER = () => ({
  type: UI_OPEN_DIMMER
})

export const CLOSE_DIMMER = () => ({
  type: UI_CLOSE_DIMMER
})
